...
class _RideBottomSheetState extends State<RideBottomSheet> {
  ...
  Widget build(BuildContext context) {
    ...
    DirectionDetails tripDetails =   Provider.of<AppData>(context, listen: false).tripDirectionDetails;
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      children: [
                        ...
                        SizedBox(height: 8.0),
                        Text(
                          ((tripDetails != null) ? tripDetails.distanceText : ''),
                          style: Theme.of(context).textTheme.bodyText1,
                        ),
                        SizedBox(
                          height: 12.0,
                              ...
                              children: [
                                ...
                                Column(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      ...
                                      ((tripDetails != null) ? ' ${tripDetails.durationText}' : ''),
                                      style: Theme.of(context).textTheme.bodyText1,
                                    ),
                                  ],
                                ),
                                ...
                                Column(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      //((widget.tripDirectionDetails != null) ? 'EGP ${MapsApiService.calculateFares(widget.tripDirectionDetails)}' : 'null'),
                                      ((tripDetails != null) ? 'EGP ${MapsApiService.calculateFares(tripDetails, context)}' : ''),
                                      style: Theme.of(context).textTheme.bodyText1,
                                    ),
                                  ],
                                ),
