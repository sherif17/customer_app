 ...
 String jwtToken;
  ...
  async {
    var res = await Navigator.push(
        context,
        MaterialPageRoute(builder: (context) => ToWinchMap()
        ));
...
@override
  ...
  Widget build(BuildContext context) {
    ...
    var pickUpLocation = Provider.of<AppData>(context, listen: false).pickUpLocation;
    var dropOffLocation = Provider.of<AppData>(context, listen: false).dropOffLocation;
    ...
    WinchRequestModel winchRequestModel = new WinchRequestModel(dropOffLocationLat:dropOff_Lat,dropOffLocationLong:dropOff_Long,pickupLocationLat:pickUp_Lat,pickupLocationLong:pickUp_Long);
                    ...
                    return Padding(
                      ...
                      child: Column(
                        children: [
                          ...
                          SizedBox(height: 8.0),
                          Text(
                            ((widget.tripDirectionDetails != null) ? widget.tripDirectionDetails.distanceText : ''),
                            style: Theme.of(context).textTheme.bodyText1,
                          ),
                                ...
                                children: [
                                  ...
                                  Column(
                                    ...
                                    children: [
                                      ...
                                      Text(
                                        ((widget.tripDirectionDetails != null) ? ' ${widget.tripDirectionDetails.durationText}' : ''),
                                        style: Theme.of(context).textTheme.bodyText1,
                                      ),
                                    ],
                                  ),
                                  ...
                                  Column(
                                    ...
                                    children: [
                                      ...
                                      Text(
                                        ((widget.tripDirectionDetails != null) ? 'EGP ${MapsApiService.calculateFares(widget.tripDirectionDetails)}' : ''),
                                        style: Theme.of(context).textTheme.bodyText1,
                                      ),
                                    ],
                                  ),
